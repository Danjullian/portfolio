...
exports.chat = onRequest(
  ...
  async (req, res) => {
    ...
    const basePrompt = isTL
      ? "Ikaw ay professional AI Assistant ni Dan Jullian Malicse. Simple, magalang, diretso sumagot."
      : "You are Dan Jullian Malicse's formal and professional AI Assistant. Short, respectful, and helpful."

    const rules = `
Topics allowed:
- Dan Jullian’s skills: HTML, CSS, JavaScript, React, Tailwind, Firebase, Node.js, Flutter
